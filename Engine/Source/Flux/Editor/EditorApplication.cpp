...
namespace Flux {
	...
	void EditorApplication::OnUpdate()
	{
		...
		cameraSettings.ViewMatrix = glm::translate(glm::mat4(1.0f), { 0.0f, 0.0f, 0.0f });
		...
		m_RenderPipeline->DrawQuad({ 0.5f, 0.0f, 0.0f }, rotation, { 1.0f, 1.0f }, m_Texture, { 0.4f, 0.8f, 0.2f, 1.0f });
		m_RenderPipeline->DrawQuad({ -0.5f, 0.0f, 0.0f }, -rotation, { 1.0f, 1.0f }, m_Texture, { 0.8f, 0.4f, 0.2f, 1.0f });
